...
public class LTDescr
{
	...
	public LTDescr setAlpha(){
		...
		this.initInternal = ()=>{
			...
			if(ren!=null){
				...
				}else if(trans.GetComponent<ShapeRenderer>() != null){
					this.fromInternal.x = trans.GetComponent<ShapeRenderer>().Color.a;
			...
			this.easeInternal = ()=>{
				...
				}else if(this.shapeRen != null){
					this.shapeRen.Color = new Color( this.shapeRen.Color.r, this.shapeRen.Color.g, this.shapeRen.Color.b, val);
					alphaRecursiveSprite(this.trans, val);
				}else{
					alphaRecursive(this.trans, val, this.useRecursion);
				}
		...
		this.easeInternal = ()=>{
			UnityEngine.Profiling.Profiler.BeginSample("setAlpha");
			newVect = easeMethod();
			val = newVect.x;
			#if UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2
			alphaRecursive(this.trans, val, this.useRecursion);
	...
	public LTDescr setTextAlpha(){
		...
		this.initInternal = ()=>{
			this.tmpText = trans.GetComponent<TMP_Text>();
			this.fromInternal.x = this.tmpText != null ? this.tmpText.color.a : 1f;
		};
	...
	public LTDescr setColor(){
		...
		this.initInternal = ()=>{
			...
			if(renColor!=null){
				...
				if(trans.GetComponent<Renderer>()!=null && trans.GetComponent<Renderer>().material.HasProperty("_Color")){
					...
					Color col = trans.GetComponent<ShapeRenderer>().Color;
					this.setFromColor( col );
				}else if(trans.childCount>0){
					foreach (Transform child in trans) {
						if(child.gameObject.GetComponent<Renderer>()!=null){
		...
		this.easeInternal = ()=>{
			UnityEngine.Profiling.Profiler.BeginSample("setColor");

			UnityEngine.Profiling.Profiler.BeginSample("new color");
			newVect = easeMethod();
			val = newVect.x;
			...
			if(this.spriteRen!=null){
				UnityEngine.Profiling.Profiler.BeginSample("sprite render recursive");
				this.spriteRen.color = toColor;
				colorRecursiveSprite( trans, toColor);
				UnityEngine.Profiling.Profiler.EndSample();
			}else if(this.shapeRen != null){
				UnityEngine.Profiling.Profiler.BeginSample("shape render recursive");
				this.shapeRen.Color = toColor;
				colorRecursiveSprite( trans, toColor);
				UnityEngine.Profiling.Profiler.EndSample();
			}
			else{
				UnityEngine.Profiling.Profiler.BeginSample("color recursive");
			...
			if(dt!=0f && this._optional.onUpdateColor!=null){
				UnityEngine.Profiling.Profiler.BeginSample("onUpdateColor");
				this._optional.onUpdateColor(toColor);
				UnityEngine.Profiling.Profiler.EndSample();
			}else if(dt!=0f && this._optional.onUpdateColorObject!=null){
				UnityEngine.Profiling.Profiler.BeginSample("onUpdateColorObject");
	...
	public LTDescr setTextColor(){
		...
		this.initInternal = ()=>{
			this.tmpText = trans.GetComponent<TMP_Text>();
			this.setFromColor( this.tmpText != null ? this.tmpText.color : Color.white );
		};
		this.easeInternal = ()=>{
			newVect = easeMethod();
			val = newVect.x;
			Color toColor = tweenColor(this, val);
			this.tmpText.color = toColor;
			if (dt!=0f && this._optional.onUpdateColor != null)
				this._optional.onUpdateColor(toColor);
	...
	public LTDescr setMove(){
		...
		this.easeInternal = ()=>{
			UnityEngine.Profiling.Profiler.BeginSample("setMove");
			newVect = easeMethod();
	...
	public LTDescr setMoveLocal(){
		...
		this.easeInternal = ()=>{
			UnityEngine.Profiling.Profiler.BeginSample("setMoveLocal");
			newVect = easeMethod();
	...
	public LTDescr setScale(){
		...
		this.easeInternal = ()=>{
			UnityEngine.Profiling.Profiler.BeginSample("setScale");
			newVect = easeMethod();
	...
	*/
	...
	public bool updateInternal(){
		...
		UnityEngine.Profiling.Profiler.BeginSample("Direction");
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
		if(this.delay<=0f && directionLocal!=0f){
			...
			UnityEngine.Profiling.Profiler.BeginSample("LTDescr Init");
			...
			UnityEngine.Profiling.Profiler.BeginSample("LTDescr Ease Internal");
			this.easeInternal();
			UnityEngine.Profiling.Profiler.EndSample();

			UnityEngine.Profiling.Profiler.BeginSample("LTDescr update callback");
			...
			if(isTweenFinished){ // increment or flip tween
				...
				UnityEngine.Profiling.Profiler.BeginSample("LTDescr call on complete");
