...
public class MarkovModelBuilder
{
  ...
  public MarkovModelBuilder(int order)
  {
    _order = order;
  }

  public MarkovModelBuilder Teach(IEnumerable<string> examples)
  {
  ...
  public MarkovModelBuilder Teach(string example)
  {
