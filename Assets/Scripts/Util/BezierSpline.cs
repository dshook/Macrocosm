...
public class BezierSpline : MonoBehaviour {
    ...
    public void RemoveCurve(bool fromFront = false) {
        if(fromFront){
            if(points.Length < 7){
                return;
            }
            //removing from the front just means shifting all the points towards the front by 3
            //then chopping off the back 3 as usual
